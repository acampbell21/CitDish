...
class PaymentPlanModal extends Component {
  render() {
    return(
     <div>
        <Grid textAlign='center' centered columns={12}>
          <Grid.Row>
            <Grid.Column style={styles.paymentButton} mobile={16} tablet={8} computer={4} >
              <Modal  
                trigger={<Button color='blue' size='big'>Start Paying Annually</Button>} 
                closeIcon
              >
